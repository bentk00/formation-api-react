...
use App\Controller\InvoiceCancelController;
 ...
 *              "controller" = InvoiceCancelController::class,
 *              "swagger_context" = {
...
class Invoice
{
     ...
     * @Assert\NotBlank(message="Le montant de la facutre est obligaroie!")
     * @Groups ({"invoices_read", "customers_read", "invoices_subresource"})
     ...
     * @Assert\Type (type="DateTimeInterface", message="La date doit être au format YYY-MM-DD !")
     */
    private $sentAt;
